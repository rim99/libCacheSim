//
//  a T3LRU module that supports different obj size
//
//
//  T3LRU.c
//  libCacheSim
 ...
 * @param cache_specific_params T3LRU specific parameters, should be NULL
 */
...
#ifdef USE_BELADY
  snprintf(cache->cache_name, CACHE_NAME_ARRAY_LEN, "T3LRU_Belady");
#endif
